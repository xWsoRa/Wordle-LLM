...
Guess the word in ten attempts or less.
...
def play_wordle(word):
    ...
    with open(r"wordle_history_baseline.txt", 'a') as history_file:
...
def main():
    ...
    while games < 100:  # Alter the total number of games as needed
        ...
        if result:
            ...
            print(f"Failed to guess the word '{word}' in 10 attempts.")
